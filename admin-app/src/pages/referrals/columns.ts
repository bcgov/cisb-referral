...
export const REFERRAL_COLUMNS: ReferralColumn[] = [
  ...
  {
    key: "currentlyHomeless",
    label: "Currently Homeless",
    width: "w-[150px]",
    render: (r) => labelOf(yesNoUnknownLabels, r.currentlyHomeless),
  },
  {
    key: "losingHousing",
    label: "Losing Housing",
    width: "w-[140px]",
    render: (r) => labelOf(yesNoUnknownLabels, r.losingHousing),
  },
  {
    key: "pendingRelease",
    label: "Pending Release",
    width: "w-[200px]",
    render: (r) => labelOf(releaseFromLabels, r.pendingRelease),
  },
  {
    key: "releaseDate",
    label: "Release Date",
  ...
  },
  {
    ...
    width: "w-[300px]",
    render: (r) => text(r.referralSummary),
  },
  {
